...
namespace Biomorpher.IGA
{
    class OutputData
    {
        ...
        public void SetSliderData(List<GH_NumberSlider> incoming)
        {
            sliderData = new List<GH_NumberSlider>(incoming);
        }

        public void SetGenePoolData(List<GalapagosGeneListObject> incoming)
        {
            genepoolData = new List<GalapagosGeneListObject>(incoming);
        }
